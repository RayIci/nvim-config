...
local hide_by_pattern = { -- uses glob style patterns
    --"*.meta",
    --"*/src/*/tsconfig.json",
    ".venv*",
    ".env*",
...
local never_show = { -- remains hidden even if visible is toggled to true, this overrides always_show
    ".DS_Store",
    "thumbs.db",
    "__pycache__",
}

local never_show_by_pattern = { -- uses glob style patterns
    --".null-ls_*",
}
...
require("neo-tree").setup({
    ...
    filesystem = {
        filtered_items = {
            ...
            never_show_by_pattern = never_show_by_pattern,
        },
        follow_current_file = {

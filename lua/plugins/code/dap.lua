...
function M.keymaps()
    require "which-key".add {
        ...
        { "<leader>ds", "<cmd>lua require('plugins.code.dap-ui').open_float('scopes')<cr>",      desc = "Floating Scopes" },
        { "<leader>dS", "<cmd>lua require('plugins.code.dap-ui').open_float('stacks')<cr>",      desc = "Floating Stacks" },
        { "<leader>dw", "<cmd>lua require('plugins.code.dap-ui').open_float('watches')<cr>",     desc = "Floating Watches" },
        { "<leader>dB", "<cmd>lua require('plugins.code.dap-ui').open_float('breakpoints')<cr>", desc = "Floating Breakpoint" },

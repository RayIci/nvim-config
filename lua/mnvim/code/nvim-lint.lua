_G.mnvim.code.linters = {}

mnvim.code.linters.show_error_if_linter_not_found = true

local linter_configurations = {}
---Configure the default setups for a linter
---@param linter string linter name
---@param opts table
function mnvim.code.linters.configure_linter(linter, opts)
    if opts == {} then
        return
    end
...
function mnvim.code.linters.register_for_filetype(filetype, linter, opts)
    opts = opts or {}
